...
export const QuizConfirmDelete: React.FC = () => {
    ...
    const { quizSelected, deleteQuiz } = useQuiz()
    ...
    return (
        <ModalLayout isOpen={isOpen} title='Eliminar Quizz'>
            <div className='space-y-4'>
                
                <p className={`text-center ${isDarkTheme ? 'text-gray-300' : 'text-gray-700'}`}>
                    ¿Estás seguro de que deseas eliminar el quizz <span className='font-semibold'>{quizSelected.title}</span>?
                </p>
