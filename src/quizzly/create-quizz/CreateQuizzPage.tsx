        ...
        <div className="max-w-5xl mx-auto">
          ...
          <section
            className={`
              ...
              ${isDarkTheme
                ? 'bg-linear-to-br from-gray-800 to-gray-900 border-gray-700 shadow-2xl shadow-black/40'
                : 'bg-linear-to-br from-white to-gray-50 border-gray-200 shadow-xl shadow-gray-300/40'
              }
            `}
          >
            <div
              className={`
                border-b px-8 py-6 transition-colors
                ${isDarkTheme
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-2 h-6 bg-linear-to-b from-blue-500 to-blue-600 rounded-full" />
                <h3
